...
const std::array<TestType, 16> kTests = {{
    TestType{"area_1d_0_1", InType{0.005, {{0.0, 1.0}}, one}, count_n_dim_area({{0.0, 1.0}})},

    TestType{"area_2d_0_1_x_0_1", InType{0.005, {{0.0, 1.0}, {0.0, 1.0}}, one},
    ...
    TestType{"linear_1d_0_2", InType{0.01, {{0.0, 2.0}}, linear_1d}, int_linear_1d(0.0, 2.0)},

    TestType{"x2_1d_0_1", InType{0.005, {{0.0, 1.0}}, x2_1d}, int_x2_1d(0.0, 1.0)},

    TestType{"x3_1d_0_1", InType{0.005, {{0.0, 1.0}}, x3_1d}, int_x3_1d(0.0, 1.0)},

    TestType{"x4_1d_0_1", InType{0.005, {{0.0, 1.0}}, x4_1d}, int_x4_1d(0.0, 1.0)},

    TestType{"exp_1d_0_1", InType{0.005, {{0.0, 1.0}}, exp_1d}, int_exp_1d(0.0, 1.0)},

    TestType{"cos_1d_0_pi2", InType{0.001, {{0.0, std::numbers::pi / 2.0}}, cos_1d},
             int_cos_1d(0.0, std::numbers::pi / 2.0)},

    TestType{"sin_1d_0_pi", InType{0.001, {{0.0, std::numbers::pi}}, sin_1d}, int_sin_1d(0.0, std::numbers::pi)},

    TestType{"xy_2d_0_1_x_0_1", InType{0.005, {{0.0, 1.0}, {0.0, 1.0}}, xy_2d}, int_xy_2d(0.0, 1.0, 0.0, 1.0)},

    TestType{"x_plus_y_2d_0_1_x_0_1", InType{0.005, {{0.0, 1.0}, {0.0, 1.0}}, x_plus_y_2d},
             int_x_plus_y_2d(0.0, 1.0, 0.0, 1.0)},

    TestType{"x2_y_2d_0_1_x_0_1", InType{0.005, {{0.0, 1.0}, {0.0, 1.0}}, x2_y_2d}, int_x2_y_2d(0.0, 1.0, 0.0, 1.0)},
